...
@triton.jit
def softcap_swa_attention_naive_prefill(
    query_base,
    key_base,
    value_base,
    kv_cache_base,
...
@triton.jit
def softcap_swa_attention_naive_decode(
    query_base,
    key_base,
    value_base,
    kv_cache_base,
...
@triton_op("rbln_triton_ops::softcap_swa_attention_naive_prefill", mutates_args=())
def softcap_swa_attention_naive_prefill_wrapper(
    query: torch.Tensor,
    key: torch.Tensor,
    value: torch.Tensor,
    ...
    warmup(softcap_swa_attention_naive_prefill, *params)

    return output.to(original_dtype)


@register_fake("rbln_triton_ops::softcap_swa_attention_naive_prefill")
def _(
    query: torch.Tensor,
    key: torch.Tensor,
    value: torch.Tensor,
...
@triton_op("rbln_triton_ops::softcap_swa_attention_naive_decode", mutates_args=())
def softcap_swa_attention_naive_decode_wrapper(
    query: torch.Tensor,
    key: torch.Tensor,
    value: torch.Tensor,
    kv_cache: torch.Tensor,
    ...
    warmup(softcap_swa_attention_naive_decode, *params)

    return output.to(original_dtype)


@register_fake("rbln_triton_ops::softcap_swa_attention_naive_decode")
def _(
    query: torch.Tensor,
    key: torch.Tensor,
    value: torch.Tensor,
